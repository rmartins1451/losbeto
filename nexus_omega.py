...
# Dynamic Pricing
PREDICTIVE_PRICING = os.environ.get("PREDICTIVE_PRICING", "true").lower() == "true"
...
def _build_402(endpoint: str):
    ...
    payload = {
        ...
        "upsell": {
            "try_free": [f"{base}/launch-risk-preview", f"{base}/sample",
                         f"{base}/losbeto-alpha", f"{base}/receipts"],
            "cheapest_paid": {"endpoint": f"{base}/pyth-price", "usd": "0.005"},
        ...
        def wrapped():
            ...
            if request.args.get("preview") == "1":
                ...
                return jsonify({"preview": True, "status": "warming_up",
                    "note": "No cached sample yet — first paid call populates it.",
