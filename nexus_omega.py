...
def bootstrap_trust():
    ...
    ok, info = SOL.verify_payment(tx_sig, 0.01, RECEIVE_ADDRESS, max_age=86400)
    if not ok:
...
# ============================================================================
# 14b. v17 REVENUE — ENDPOINTS REVOLUCIONÁRIOS
# ============================================================================
#
...
<div class="header">
  <div><h1>⚡ Losbeto <span class="badge">v17 REVENUE</span></h1>
...
<div class="grid" style="grid-template-columns:repeat(auto-fit,minmax(250px,1fr))">
  ...
  <div class="card">
    <h3>🔍 Escanear TX (v17)</h3>
    <div class="sub" style="margin-top:8px">
      <code style="font-size:10px">GET /scan-tx?sig=&lt;signature&gt;</code>
      <div style="margin-top:6px">Valida se uma tx Phantom paga o RECEIVE_ADDRESS</div>
    </div>
  </div>
  <div class="card">
...
<div class="footer">Atualização automática a cada 10s. Win-rate dirige preço (PoI). v17 REVENUE — <a href="/register-marketplaces" target="_blank">Registrar Marketplaces</a> • <a href="/health/deep" target="_blank">Deep Health</a> • <a href="/.well-known/x402.json" target="_blank">x402.json</a></div>
<script>
