...
"""
================================================================================
 OMEGA SWARM v22.0.0-REVOLUTION — "The Autonomous Intelligence Layer"
================================================================================
 Upgrade: Losbeto v21.21.0-P0 → Omega Swarm v22.0.0-REVOLUTION
...
VERSION = "22.0.0-REVOLUTION"
BRAND_NAME = "Omega Swarm"
BRAND_TAGLINE = "The Autonomous Intelligence Layer for Crypto Agents"
BRAND_EMOJI = "🧠"
...
LOG_PATH        = HOME_DIR / "omega_v22.log"
CONFIG_PATH     = HOME_DIR / "config_v22.json"
RAG_DB_PATH     = HOME_DIR / "rag_v22.db"
...
SUBSCRIPTION_TIERS = {
    "pro": {
        ...
        "calls_per_month": 500,
        "features": ["all_endpoints", "priority_support", "webhook_alerts", "alpha_signals"],
        "badge": "💎 Pro",
    },
    "whale": {
        "name": "Omega Whale",
        "price_usdc_monthly": 29.99,
        "calls_per_month": -1,  # ilimitado
        "features": ["all_endpoints", "priority_support", "webhook_alerts", "alpha_signals", 
                       "custom_endpoints", "dedicated_channel", "api_key_access"],
        "badge": "🐋 Whale",
    },
}
...
ACHIEVEMENTS = {
    "first_purchase": {"name": "First Blood", "desc": "Primeira compra no Omega Swarm", "points": 100},
    "streak_7": {"name": "Diamond Hand", "desc": "7 dias de compras consecutivas", "points": 500},
    "streak_30": {"name": "Omega Loyalist", "desc": "30 dias de compras consecutivas", "points": 2000},
    "volume_10": {"name": "Volume Trader", "desc": "$10+ em compras totais", "points": 300},
    "volume_100": {"name": "Whale Status", "desc": "$100+ em compras totais", "points": 1500},
    "volume_1000": {"name": "Legend", "desc": "$1,000+ em compras totais", "points": 5000},
    "referral_5": {"name": "Evangelist", "desc": "5 amigos compraram via seu link", "points": 1000},
    "referral_25": {"name": "Influencer", "desc": "25 amigos compraram via seu link", "points": 5000},
    "all_endpoints": {"name": "Completionist", "desc": "Comprou todos os 48 endpoints", "points": 2500},
    "council_10": {"name": "Council Regular", "desc": "10x /council", "points": 800},
}

# Affiliate System
AFFILIATE_COMMISSION_PCT = 30.0  # 30% vitalícia
AFFILIATE_BONUS_TIERS = {
    10: {"reward": "lifetime_pro", "desc": "Indique 10 → PRO vitalício"},
    50: {"reward": "lifetime_whale", "desc": "Indique 50 → WHALE vitalício"},
    100: {"reward": "revenue_share_5pct", "desc": "Indique 100 → 5% do revenue total"},
}

# Early Bird Pricing (primeiros 100 compradores)
EARLY_BIRD_MAX = 100
...
BASE_PRICES = {
    "/bootstrap-trust":  0.050,   # was 0.010 -> 5x
    "/fear-greed":       0.050,   # was 0.010 -> 5x
    "/pyth-price":       0.030,   # was 0.010 -> 3x
    "/trust-hash":       0.030,   # was 0.010 -> 3x
    "/web-search":       0.050,   # was 0.015 -> 3.3x
    "/ai-news":          0.050,   # was 0.015 -> 3.3x
    "/regime":           0.080,   # was 0.020 -> 4x
    "/mempool":          0.080,   # was 0.020 -> 4x
    "/agent-market":     0.080,   # was 0.020 -> 4x
    "/geo-alpha":        0.100,   # was 0.025 -> 4x
    "/sentiment":        0.120,   # was 0.030 -> 4x
    "/anomalias":        0.120,   # was 0.030 -> 4x
    "/dex-screen":       0.120,   # was 0.030 -> 4x
    "/jupiter-swap":     0.150,   # was 0.040 -> 3.75x
    "/rugcheck":         0.150,   # was 0.040 -> 3.75x
    "/pump-monitor":     0.200,   # was 0.050 -> 4x
    "/defi-yield":       0.200,   # was 0.050 -> 4x
    "/swarm-vote":       0.250,   # was 0.060 -> 4.2x
    "/sinais":           0.250,   # was 0.070 -> 3.6x
    "/analise":          0.350,   # was 0.090 -> 3.9x
    "/nansen-flow":      0.350,   # was 0.090 -> 3.9x
    "/backtest":         0.500,   # was 0.120 -> 4.2x
    "/tg-premium":       0.500,   # was 0.120 -> 4.2x
    "/agent-call":       0.500,   # was 0.120 -> 4.2x
    "/onchain-credit":   0.500,   # was 0.120 -> 4.2x
    "/deep-think":       0.600,   # was 0.140 -> 4.3x
    "/sec-filing":       0.600,   # was 0.150 -> 4x
    "/relatorio":        0.750,   # was 0.180 -> 4.2x
    "/sanctions":        0.750,   # was 0.180 -> 4.2x
    "/arbitrage":        0.800,   # was 0.200 -> 4x
    "/whale-alert":      0.800,   # was 0.200 -> 4x
    "/cross-chain":      1.000,   # was 0.250 -> 4x
    "/smart-money":      1.000,   # was 0.250 -> 4x
    "/copytrade":        1.500,   # was 0.350 -> 4.3x
    "/alpha-signal":     1.500,   # was 0.400 -> 3.75x
    "/insider-track":    2.000,   # was 0.500 -> 4x
    "/mev-flow":         2.500,   # was 0.600 -> 4.2x
    "/market-brief":      1.000,   # was 0.250 -> 4x
    "/portfolio-copilot": 1.500,   # was 0.390 -> 3.8x
    "/launch-risk":       1.500,   # was 0.350 -> 4.3x (FLAGSHIP)
    "/council":           2.000,   # was 0.490 -> 4x (EXCLUSIVO)
    "/launch-sniper":     2.000,   # was 0.490 -> 4x
    "/whale-dossier":     2.500,   # was 0.590 -> 4.2x
    "/thesis-engine":     3.000,   # was 0.690 -> 4.3x
    "/starter-pack":      4.99,    # was 1.000 -> 5x
    # v22 exclusivos
    "/multi-chain-arbitrage": 0.500,   # was 0.150 -> 3.3x
    "/win-rate-verified":     0.300,   # was 0.080 -> 3.75x
    "/agent-composable":      0.800,   # was 0.300 -> 2.7x
}

FEATURED_ENDPOINTS = [
    "/launch-risk", "/council", "/agent-composable",
    "/multi-chain-arbitrage", "/win-rate-verified",
    "/starter-pack", "/thesis-engine", "/market-brief",
    "/whale-dossier", "/portfolio-copilot", "/alpha-signal",
    "/mev-flow", "/smart-money", "/copytrade", "/rugcheck",
    "/subscribe-pro", "/subscribe-whale",  # v22
]
...
ENDPOINT_DESC = {
    ...
    "/council":         "EXCLUSIVO: Conselho dos Cinco — 5 IAs especializadas (risco, regime, launches, liquidez, contrarian) votam em paralelo + síntese do Chairman",
    "/launch-risk":     "FLAGSHIP: Launch Risk Brief — risco de lançamento em tempo real (on-chain + DEX + IA) com veredicto acionável",
    ...
    "/subscribe-pro":         "Assinatura Omega Pro - 500 chamadas/mes",
    "/subscribe-whale":       "Assinatura Omega Whale - Ilimitado",
}
    ...
    def council():
        ...
        AGENTS = [
            ...
            ("Whale",     "liquidez",   lambda: _safe(Brain.defi_yield, {}),
             lambda d: "BULLISH" if d.get("best_yields") else "NEUTRAL"),
            ("Contrarian","sentimento", lambda: _safe(Brain.sentiment, {}),
             lambda d: {"BULLISH":"BEARISH","BEARISH":"BULLISH"}.get(str(d.get("bias","")).upper(), "NEUTRAL")),
        ]
...
<p class="lead">6 features que nenhum outro node no ecossistema x402 oferece — grade completa, sem lacunas:</p>

<div class="grid3">
  <div class="feat" style="border-color:#7B61FF">
    <div class="ic">🚀</div>
    <h3>Launch Risk Brief <span class="tag hot">FLAGSHIP</span></h3>
    <p>Risco de lançamento em tempo real: checks on-chain + liquidez DEX + veredicto de IA (AVOID/WATCH/SIZE). Preview grátis em <code>/launch-risk-preview</code> · completo em <code>/launch-risk</code> ($0.35)</p>
  </div>
  <div class="feat">
    <div class="ic">🧾</div>
