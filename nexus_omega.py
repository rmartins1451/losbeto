...
VERSION = "23.2.0-VENDEDOR"
BRAND_NAME = "Losbeto"
BRAND_TAGLINE = "The Revenue Engine for Crypto Agents"
BRAND_EMOJI = "🧠"
...
LOG_PATH        = HOME_DIR / "omega_v23.log"
CONFIG_PATH     = HOME_DIR / "config_v23.json"
RAG_DB_PATH     = HOME_DIR / "rag_v23.db"
...
CREDIT_PLANS = {
    "/buy-credits":      {"plan": "credits",  "balance_usd": 1.25,  "ttl_days": 30,
                          "bonus": "+25% de bônus", "pitch": "Pague $1 uma vez, use $1.25 em chamadas — sem settlement por request"},
    "/day-pass":         {"plan": "day-pass", "balance_usd": -1,    "ttl_days": 1,
                          "bonus": "ilimitado 24h", "pitch": "Um dia inteiro de chamadas ilimitadas em todos os endpoints"},
    "/subscribe-pro":    {"plan": "pro",      "balance_usd": 15.00, "ttl_days": 30,
                          "bonus": "+50% de bônus", "pitch": "Saldo de $15/mês em chamadas — para agentes em produção"},
    "/subscribe-whale":  {"plan": "whale",    "balance_usd": -1,    "ttl_days": 30,
                          "bonus": "ilimitado 30d", "pitch": "Ilimitado por 30 dias + prioridade — para whales e bots de alta frequência"},
}
...
BASE_PRICES = {
    ...
    "/copytrade":        0.250,
    "/market-brief":     0.250,
    "/multi-chain-arbitrage": 0.250,
    "/agent-composable": 0.300,
    "/alpha-signal":     0.300,
    "/insider-track":    0.300,
    "/mev-flow":         0.350,
    "/portfolio-copilot": 0.350,
    "/launch-risk":      0.350,   # FLAGSHIP acessível — preview grátis em /launch-risk-preview
