...
<div class="header">
  <div><h1>⚡ Losbeto <span class="badge">v19 REVOLUTIONARY</span></h1>
...
<div class="grid" style="grid-template-columns:repeat(auto-fit,minmax(250px,1fr))">
  ...
  <div class="card">
    ...
    <div class="sub" style="margin-top:8px">
      ...
      <div style="margin-top:4px"><a href="/debug-tx?sig=59Mn4RefaRf8ECRafYE7x4mTm2pkvJZGeekfVyzwyXLfA34eA1xdM7UzMq4RhNGv5pRXeuEG9B5mrt9tg9pviRvH" target="_blank">Testar</a></div>
    </div>
  </div>
  <div class="card">
...
<div class="footer">Atualização automática a cada 10s. Win-rate dirige preço (PoI). v19 REVOLUTIONARY</div>
<script>
...
def autoregister_x402scan():
    ...
    try:
        ...
        log.info("=" * 62)
        # Registro automático nos marketplaces (simplificado)
        try:
