...
<div class="header">
  <div>
    <h1>LOSBETO<span class="badge">v19</span></h1>
...
<div class="footer">refresh 10s · win-rate dirige preço via PoI multiplier · Losbeto v19</div>
<script>
const CATEGORY_MAP = {
...
async function reload(){
  ...
  const trustActive = j.stats.paid_24h >= 3 || j.stats.total_usdc > 0;
