...
- [NexusAI Crypto Intelligence API](https://losbeto-production-dd7c.up.railway.app) - Pay-per-call crypto market analysis for AI agents. 6 endpoints: fear & greed index, market regime, anomaly detection, full analysis, trading signals, and premium reports. $0.01–$0.25 USDC per call on Solana mainnet. No signup, no API keys. Coinbase CDP facilitator. ([llms.txt](https://losbeto-production-dd7c.up.railway.app/llms.txt)) ([OpenAPI](https://losbeto-production-dd7c.up.railway.app/openapi.json)) ([x402.json](https://losbeto-production-dd7c.up.railway.app/.well-known/x402.json))
### Games & On-Chain Apps
