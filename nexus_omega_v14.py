...
# ============================================================================
# 3. WALLET SOLANA + TON — v14 REVENUE
# ----------------------------------------------------------------------------
...
# ============================================================================
# 3b. WALLET CONSISTENCY CHECK — v14 REVENUE
# ============================================================================
...
def _verify_payment(endpoint: str, payment_header: str):
    ...
    if chain == "base":
        if not FACILITATOR:
            return False, "base-needs-facilitator (set X402_FACILITATOR=https://x402.org/facilitator)", {}
...
def bootstrap_trust():
    ...
    if request.method == "GET":
        return jsonify({
            ...
            "instructions":   [
                ...
                f"2. Envie $0.001 USDC para {RECEIVE_ADDRESS}",
    ...
    ok, info = SOL.verify_payment(tx_sig, 0.001, RECEIVE_ADDRESS, max_age=3600)
    if not ok:
...
<div class="header">
  <div><h1>⚡ Losbeto <span class="badge">v14 REVENUE</span></h1>
...
<div class="footer">Atualização automática a cada 10s. Win-rate dirige preço (PoI). v14 REVENUE.</div>
<script>
